...
import { View, Text, UIManager, LayoutAnimation, Platform, Dimensions, Image, StatusBar } from 'react-native';
        ...
        return (
            <View style={{ height: height, width: width }}>
                ...
                >
                    ...
                    style={{ color: 'white', fontSize: 19,marginLeft:249,backgroundColor: 'darkgray',padding:5 , borderTopLeftRadius:5,borderBottomLeftRadius:5 ,elevation:20, shadowColor:'black' }}>
                        Add to Cart
                    </Text>
                </View>
